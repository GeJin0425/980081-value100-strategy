"""
980081 价值100 MA250策略参数网格搜索 / OFAT扫描（遗留工具）

注意: 线上策略已切换为 pipeline/factor_strategy.py
(估值分位 + 波动率目标 + 股息率-央行利率差), 训练/测试统一为
2018-01-01~2022-12-31 / 2023-01-01~2026-12-31。
本文件保留仅用于旧MA250策略的参数研究。
